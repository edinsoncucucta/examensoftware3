    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <div class="head-section">
                        <div class="container">
                            <h3><label>Verifica Disponibilidad</label></h3>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <select class="form-control " name="tipo" id="tipo" >
                                ...
                                <%
                                    out.print(consul.tiposhs());

                                %>
                            </select>
                        </div>
                        <div class='input-group date col-sm-8 widget-right' id='datetimepicker1' >

                            <input type='text' name="daterange" id="fechas" class="form-control text-center  " disable="true" />
        ...
        <script>
            function muestraMensaje() {
                ...
                var idHabitacion = document.getElementById('tipo').value;
                 var msg="";
                ...
                if (fechas.length == 0) {
                    ...
                    xhttp.onreadystatechange = function () {
                        if (xhttp.readyState == 4 && xhttp.status == 200) {
                            if (xhttp.responseText.indexOf('error') > -1) {
                                ...
                                var info = xhttp.responseText.toString().substring(5,7);
                             
                     if(idHabitacion==0){
                         msg = " <label style='color: #3342FF;font-size: 16px;' class=\"col-ms-12 alert alert-info\">Tipo de Habitacion no seleccionada</label>";
                     } 
                     else if( info.toString().localeCompare("no")===0){
                        
                                   msg = " <label style='color: #FF3333;font-size: 16px;' class=\"col-ms-12 alert alert-danger\">La habitación no está disponible</label>";
                              
                }else{
                           
                                      msg = " <label style='color: #2ca88d;font-size: 16px;' class=\"col-ms-12 alert alert-success\">Habitación disponible para la fecha "+fechaIni+" - "+fechaFin+"</label>";
                }
                                document.getElementById('mesanjeDisponibilidad').innerHTML = msg;
                    ...
                    //ubiqueme donde este index1
                    var url = "disponibilidadHabitacion.jsp?idHabitacion=" + idHabitacion + "&fechaIni=" + fechaIni
                    + "&fechaFin=" + fechaFin;

<%-- 
    Document   : historialServi
    Created on : 30-nov-2016, 3:13:38
    Author     : macaco
--%>
 ...
 %>
    ...
    <body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
                                                    <form  method="GET" action="historialServi.jsp" >
							<form role="form">
        ...
        Reserva reserva2=c.buscarReservaporHuesped(bus);
         ...
         if(reserva2!=null){
             ArrayList<Servicios>servis=c.serviciosporreserva(reserva2.getId());
        %>

...
function cargoempleado() { 
    ...
    var msg = "";
       if (name===""){ 
      	 toastr.options = {
                ...
                toastr.warning("Error campo descripcion incompleto", "Ooops!");
      	return 0; 
       }
    else{
    ...
    $.blockUI({
        message: 'Registrando nuevo cargo ',
        css: {
            border: 'none',
            padding: '25px',
            backgroundColor: '#000',
    ...
    var text = "registrado_cargo_emp.jsp?name="+name;

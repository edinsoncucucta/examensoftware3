...
<%@page import="co.ufps.edu.dto.tipo_habitacion"%>
...
<%
        int Param1= Integer.parseInt(request.getParameter ("id"));
          ...
          tipo_habitacion t=tipoh.consultarid(Param1);
        %>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="actualizar_tipo_habitacion.jsp" method="post">
								...
								<!-- id input-->
								<% 
                                                                    out.print("<div class=\"form-group\"> <label class=\"col-md-2 control-label\" for=\"idh\">ID Tipo de Habitacion </label>"+
									"<div class=\"col-md-10\">"+"<p class=\"form-control-static\" Style=\"font-size:16px\"> "+Param1+"</p>"+
									...
									<div class="col-md-10">
										<input id="name" name="name" type="text" value="<%out.print(t.getNombre()); %>" class="form-control">
									</div>
								</div>
                                                                <!-- Precio input-->
								<div class="form-group">
									<label class="col-md-2 control-label" for="precio">Precio de la habitación</label>
									<div class="col-md-10">
										<input id="precio" name="precio" type="number" value="<%out.print(t.getPreciobase()); %>" class="form-control">
									</div>
								</div>
